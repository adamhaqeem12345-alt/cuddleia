                    ...
                    <div>
                        <div className="space-y-6">
                           ...
                           <div>
                               ...
                               <Input id="phone" type="number" inputMode="numeric" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="e.g., 60123456789" required className="rounded-full"/>
                           </div>
                        </div>
