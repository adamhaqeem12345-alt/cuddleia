        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-start">
          <div className="w-full">
            <Dialog>
              ...
              <DialogContent className="max-w-4xl h-auto p-4 bg-transparent border-0 shadow-none">
          ...
          <div className="flex h-full flex-col">
            <div className="flex flex-1 flex-col rounded-lg border bg-card text-card-foreground shadow-sm">
              <div className="flex flex-col space-y-1.5 p-6">
                ...
                <p className="font-headline text-3xl lg:text-4xl font-bold text-primary pt-2">${product.price.toFixed(2)}</p>
              </div>
