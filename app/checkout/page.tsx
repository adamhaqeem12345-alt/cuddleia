...
import { Loader2, ArrowLeft, AlertTriangle, Wallet } from 'lucide-react';
...
export default function CheckoutPage() {
    ...
    const [errorMessage, setErrorMessage] = useState('The payment system is currently offline. We apologize for the inconvenience.');
    ...
    useEffect(() => {
        if (isCartReady) {
            if (cart.length === 0) {
                ...
                // The payment system is offline, so we immediately set to error state.
                setStatus('error');
            }
        }
            ...
            <div className="container mx-auto px-4 py-16 sm:py-24">
                <div className="max-w-4xl mx-auto">
                     <div className="text-center mb-12">
                        ...
                        <p className="mt-2 text-muted-foreground text-lg">Please review your order.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-lg border">
                            ...
                            <div className="text-center p-6 rounded-lg bg-red-50 text-red-700 border border-red-200">
                                ...
                                <p className="mt-4 font-semibold text-lg">System Offline</p>
