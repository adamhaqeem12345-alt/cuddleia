              ...
              <div className="mx-auto max-w-4xl text-center">
                ...
                <div className="prose prose-lg mt-6 max-w-none font-body text-muted-foreground mx-auto space-y-4">
                  <p>
                    ...
                    just starting on our journey to create a cozy corner of the
                    internet where sincerity and creativity can flourish,
                    beginning with our first collection of digital wallpapers and
                    booklets.
                  </p>
                  <p>
                    We believe in honesty, so we want to be clear about how our
                    products are made. The foundational content, like the text in
                    our booklets, is generated with the help of AI. Then, every
                    piece is personally and carefully designed, refined, and
                    given its final form by hand. This combination allows us to
                    blend technological efficiency with a heartfelt, human touch
                    in everything we create.
                  </p>
                  <p>
                    Our mission is to create digital goods that uplift hearts,
                    inspire faith, and make your screens a place of comfort and
                    reflection.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-muted-foreground">
                      ...
                      hand, ensuring each product carries a genuine and personal
                      touch.
                    </p>
                  </div>
                </div>
              ...
              <div className="mx-auto mt-12 flex max-w-xl flex-col items-center gap-8 sm:flex-row">
                ...
                <div className="text-left">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    ...
                    digital spaces should inspire peace and purpose, Adam
                    masterfully blends AI-generated content with his own
                    heartfelt design to craft products that uplift, comfort, and
